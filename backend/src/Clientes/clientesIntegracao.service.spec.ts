    ...
    beforeEach(async () => {
        const module = await Test.createTestingModule({
            providers: [
                ...
                VendasService,
                ProdutosService,
                {provide: AgendamentosService, useValue: {readAppointmentByClient: AgendamentosService.prototype.readAppointmentByClient}},
                {provide: VendasService, useValue: {readSaleByClient: VendasService.prototype.readSaleByClient}},
