...
function GerenciamentoProduto({titulo, subtitulo, botoes, estados, setEstados, visualizacao}){
    ...
    return (
        <Acao titulo={titulo} subtitulo={subtitulo} botoes={botoes} campos={[
            ...
            {component: <TextField visualizacao={visualizacao} setValue={setPreco} value={preco} placeholder="Digite o preço do produto" titulo="Preço do produto" tipo="number" id="precoproduto" step="0.01"/>, buttonSupport: false},
