...
import AvisoEstoqueBaixo from "./AvisoEstoqueBaixo";
...
function Vendas() {
    ...
    useEffect(() => {
        axios.get('http://127.0.0.1:3344/vendas').then((resposta) => {
    ...
    const excluirVenda = () => {
        axios.delete(`http://127.0.0.1:3344/vendas/deletar/${saleSelected}`).then((response) => {
