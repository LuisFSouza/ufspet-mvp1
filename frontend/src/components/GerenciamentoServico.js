...
function GerenciamentoServico({titulo, subtitulo, botoes, estados, setEstados, visualizacao}){
    ...
    return (
        <Acao titulo={titulo} subtitulo={subtitulo} botoes={botoes} campos={[
            ...
            {component: <TextField visualizacao={visualizacao} setValue={setPreco} value={preco} placeholder="Digite o preço do serviço" titulo="Preço do Serviço" tipo="number" id="precoservico" step="0.01"/>, buttonSupport: false},
